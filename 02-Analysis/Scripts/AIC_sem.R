...
dataset        <- read.csv("01-Dataset_construction/Outputs/dataset_creation_output_last/dataset_for_phylosem_NOUNITCV/output_tot_stdmorpho/eladataset_phylosem.csv")
rownames(dataset) <- dataset$X
dataset_traits <-  read.csv("01-Dataset_construction/Outputs/dataset_creation_output_last/dataset_for_phylosem_NOUNITCV/output_tot_stdmorpho/eladataset_traits.csv")
...
save.image(file=paste0(pathoutput, "/compareSEM.RData"))
...
# > best.compare_phylosem(comparison) 08/09/25
# [1] 104605.1 104584.9 *** (TLstdmeca) 104613.1 104591.0 107726.7 107691.7 105418.0 105383.9 104609.0 104586.8 (TLstdLoo)


save.image(paste0(pathoutput, "/comparesem25_09_07.RData"))
# 
# 
# 
# 
...
# 28/09/25
#"stdmeca", "TLstdmeca", "stdevol00", "stdevol0", "Woo2", "TLWoo", "WooWoo2", "TLWooWoo", "stdLoo", "TLstdLoo"
# 113476.6    113456.6     113494.9     113472.7  116817.7 116784.1 114179.5   114146.5    113479.0   113457.1
